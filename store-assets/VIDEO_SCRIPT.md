# Short Recording Script (30–45s)

Goal: Capture a clean demo video for the store and README.
...
- or OBS Studio (free) → Source: Window Capture (Chrome) → Start Recording.

## Export
- Format: MP4 (H.264), 1920×1080 or 1280×800.
- Duration: 30–45 seconds.
- Trim start/end if needed (Photos/Clipchamp on Windows).

## Optional captions (non‑intrusive)
- “Start reading” when clicking Start.
- “Skip forward” when pressing Skip.
- “Auto‑Next: opening next chapter” during the transition.

Keep the cursor steady and movements minimal. Audio came from the system TTS; ensure system volume is audible.
